            ...
            <!-- ============================================================== -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">কর্মকর্তা/কর্মচারী পরিবর্তন করুন</h4>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <form method="post" action="{{url('/emp/edit/'.$employee->id)}}" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                     ...
                                                     <div class="form-group">
                                                        ...
                                                        <input id="phone" name="phone" type="text" value="{{$employee->phone}}" class="form-control">
                                                        @if($errors->has('phone'))
                                                     ...
                                                     <div class="form-group">
                                                        ...
                                                        <input id="email" name="email" type="text" value="{{$employee->email}}" class="form-control">
                                                        @if($errors->has('email'))
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input id="password" name="password" type="password" value="{{$employee->password}}" class="form-control">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="department" name="department" type="text" value="{{$employee->department}}" class="form-control">

                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label">শাখা</label>
                                                        <select name="branch" value="{{$employee->branch}}" class="form-control select2">
                                                    ...
                                                    @if($errors->has('gender'))
                                                     ...
                                                     <!-- <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-3">ছবি</h4>
                                            <div class="fallback">
                                ...
                                <!-- end card-->
                                            ...
                                            <button type="submit" class="btn btn-primary mr-1 waves-effect waves-light">পরিবর্তন করুন</button>
                                        </form>
                ...
                <script>
                 Swal.fire(
                     'success','আপডেট করা কর্মচারী সফলভাবে সম্পন্ন হয়েছে','success'
                 );
