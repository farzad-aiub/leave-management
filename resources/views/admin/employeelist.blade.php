                                  ...
                                  <div class="card-body">
                                      <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                        ...
                                        {{$employee->department}}</td>
                                          ...
                                          @php   
                              $phone = $numto->bnNum($employee->phone); 
                              
                          @endphp
                                          <td>{{$phone}}</td>
                                          @if ( $req=session()->get('role')==1 || $req=session()->get('role')==2)
                                          <td>
                                            <a href="/employee/profile/details/{{$employee->id}}" data-toggle="tooltip" data-placement="top" title="details"><i class="fas fa-eye"></i></a>
                                                <a href="/emp/edit/{{$employee->id}}" data-toggle="tooltip" data-placement="top" title="Edit" ><i  class="bx bx-edit"></i></a>
                                                <a href="/employee/delete/{{$employee->id}}" data-toggle="tooltip" data-placement="top" title="Delete"><i class="bx bx-trash"></i></a>
