            ...
            <!-- ============================================================== -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <form method="post" action="{{url('op/update/'.$oparetor->id)}}" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                <div class="col-sm-6">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="branch" value="{{$oparetor->branch}}" class="form-control select2">
                                                            <option value="{{$oparetor->branch}}" selected  >{{$oparetor->branch}}</option>
                ...
                <script>
                 Swal.fire(
                     'সফল','আপডেট করা  সফলভাবে সম্পন্ন হয়েছে','সফল'
                 );
