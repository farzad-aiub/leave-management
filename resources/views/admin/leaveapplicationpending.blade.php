                  ...
                  <div class="card">
                      <div class="card-body">
                          ...
                          @endphp
                              ...
                              <td>{{$start}} </td>
                              <td> {{$end}}</td>
                              <td> <input type="hidden" id="leave" value="{{$application->total_days}} দিন">{{$total_days}} দিন</td>
                           ...
                           @endphp
                              ...
                              <td>
                                  ...
                                  <a href="/approve/{{$application->id}}"><button class="btn btn-success"  value="1">অনুমোদন</button></a>
                                  <a href="/reject/{{$application->id}}"> <button class="btn btn-danger"  value="0">বাতিল</button></a>
