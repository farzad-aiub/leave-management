                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card overflow-hidden">
                            ...
                            <div class="card-body pt-0"> 
                                ...
                                <div class="p-2">
									<form class="form-horizontal" method="post" action="{{url('/verify/code')}}">
										@csrf
										
                                        <div class="form-group">
                                            <label for="useremail">Insert Your reset code</label>
                                            <input type="number" name="token" class="form-control" id="useremail" placeholder="Enter code">        
                                        </div>
                                        ...
                                        <h5 style="color: red">{{session('pass')}}</h5>
