                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card overflow-hidden">
                            ...
                            <div class="card-body pt-0"> 
                                ...
                                <div class="p-2">
									<form class="form-horizontal" method="post" action="{{url('/create/pass')}}">
										@csrf
										
                                        <div class="form-group">
                                            <label for="useremail">Create New  Password</label>
                                            <input type="password" name="password" class="form-control" id="useremail" require placeholder="Enter new password">        
                                        </div>
