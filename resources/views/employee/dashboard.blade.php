...
<div class="row">
    ...
    <div class="col-xl-8">
        <div class="row">
            <div class="col-sm-4">
                <div class="card" style="background-color:#926AA6; border-radius: 20px">
                    <div class="card-body">
            ...
            <div class="col-sm-4">
                <div class="card" style="background-color:#66c7ff; border-radius: 20px">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            <div class="avatar-xs mr-3">
                                <span class="avatar-title rounded-circle bg-soft-primary text-primary font-size-18">
        ...
        <div class="card" style="background-color: #926AA6; border-radius: 20px">
            <div class="card-body">
                <div class="d-flex align-items-center mb-3">
                    <div class="avatar-xs mr-3">
                        <span class="avatar-title rounded-circle bg-soft-primary text-primary font-size-18">
                            <i style="color: saddlebrown" class="bx bx-layout"></i>
                        </span>
                    </div>
                    @php
                    $c =0;
