                                    ...
                                    <div class="card-body pt-0">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                ...
                                                <h5 class="font-size-15 text-truncate">কর্মচারী</h5>
                                                @if($user->is_active =='1')
                                            ...
                                            <div class="col-sm-8">
                                                <div class="pt-4">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <h5 class="font-size-15">পদবি:{{$user->emp->department}}</h5>
                                                            <p class="text-muted mb-0">ইমেইল:{{$user->email}}</p>
                                                        </div>
                                                    </div>
                                                     <div class="mt-4">
                                                        <a href="/employee/edit/{{$user->id}}" class="btn btn-primary waves-effect waves-light btn-sm">হালনাগাদ করুন <i class="mdi mdi-arrow-right ml-1"></i></a>
                                                    </div> 
                                                </div>
                                            </div>
                                        </div>
