...
@section('main_contant')
    <form  action="{{url('/application/store')}}" class="form-horizontal" method="post" id="formfield" role="form" enctype="multipart/form-data" accept-charset="utf-8" autocomplete="off">
        <!-- start page title -->
        <div class="row">
            <div class="col-12">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">ফেরৎ </button>
